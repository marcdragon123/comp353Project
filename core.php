                ...
                <li class="searchButton papaya-bg">
                    ...
                    <ul class="vertical menu blush-bg text-center">
                        <form id="searchForm">
                            ...
                            <li>
                                Riders <br>
                                <input class="postRequestForms marginCenter" type="number" name="quantity" min="1"
                                       max="10">
                            </li>
                            <li class=" floatBottomSubmitBotton fullWidth">
                                <button class="orangeButton2 marginCenter" type="button" name="button"
                                        id="searchSubmit">Submit
                                </button>
                            </li>
                        </form>
                    </ul>
                ...
                <li class="requestButton aqua-bg">
                    ...
                    <ul class="vertical menu blush-bg text-center ">
                        <form id="requestForm">
                            ...
                            <li class=" floatBottomSubmitBotton fullWidth">
                                <button class="submitButton orangeButton2" type="button" name="button">Submit</button>
                            </li>
                        </form>
                    </ul>
                </li>
                <li class="postButton blush-bg">
                    ...
                    <ul class="vertical menu aqua-bg text-center">
                        <form id="postForm" method="post" action="backend/postRideController.php">
                            <li>
                                Single Trip <input id="radioSingle" type="radio" name="tripType" value="singleTrip"
                                                   checked><br><br>
                                Periodic <input id="radioMult" type="radio" name="tripType" value="periodic"><br><br>
                            </li>
                            <li>
                                Departure:<br>
                                <input class="postRequestForms marginCenter" id="searchDep3" type="text" size="50"
                                       placeholder="Departure Address" name="departure"><br>
                            </li>
                            <li>
                                Destination:<br>
                                <input class="postRequestForms marginCenter" id="searchDest3" type="text" size="50"
                                       placeholder="Destination Address" name="destination"><br>
                            </li>
                            <li>
                                <div id="postDate">
                                    <br>
                                    Date: <br>
                                    <input class="postRequestForms marginCenter" type="date" name="dep_date"
                                           min="2016-09-09">
                                </div>
                            </li
                            <li>
                            ...
                            <br>Distance <br> <input class="postRequestForms marginCenter" id="distance" type="text"
                                                     name="distance" value=" " style="text-align:center;" readonly><br>
                            Duration <br> <input class="postRequestForms marginCenter" id="duration" type="text"
                                                 name="duration" value=" " style="text-align:center;" readonly><br>
                            <li class=" floatBottomSubmitBotton fullWidth">
                                <button id="postMarker" class="submitButton orangeButton2" type="button" name="button">
                                    Search
                                </button>
                                <button id="postSubmit" class="submitButton orangeButton2" type="submit" name="button">
                                    Submit
                                </button>
                            </li>
                        </form>
        ...
        <div class="profCol papaya-bg">
                    ...
                    <div style="margin-left:5em; margin-right:5em; padding-top:5em;">
                        <div class="row">
                            <div class="large-6 columns">
                                ...
                                <input id="profName" type="text" size="50" placeholder=""
                                       value='<?php echo $info['user_email'] ?>'>
                            </div>
                        ...
                        <div class="row">
                            <div class="large-8 columns">
                                About me: <br>
                                <textarea rows="6" cols="50" id="profAbout" type="text" size="500"
                                          placeholder="myDesc"></textarea><br>
                            </div>
            ...
            <div class="myInbox">
                <ul class="listingsOfItems">
                    <li class="list-item "><img class="list-item-img" src="./style/small_car.png" href="#">Ride Request
                    </li>
                    <li class="list-item "><img class="list-item-img" src="./style/pedo.jpg" href="#">Ride Request</li>
                    <li class="list-item "><img class="list-item-img" src="./style/pedo.jpg" href="#">Request Accepted
                    </li>
                    <li class="list-item "><img class="list-item-img" src="./style/pedo.jpg" href="#">Message from Pedo
                        Man
                    </li>
                    <li class="list-item "><img class="list-item-img" src="./style/pedo.jpg" href="#">Message from
                        Andres
                    </li>
            ...
            <div class="wrapMapInfo">
                ...
                <div class="tripInfo">
                    ...
                    <form action="backend/takeRideController.php" method="post">
                        <input class="postRequestForms marginCenter" id="distance" type="text" name="departure"
                               value=" " style="text-align:center;" readonly>
                        <input class="postRequestForms marginCenter" id="distance" type="text" name="destination"
                               value=" " style="text-align:center;" readonly>
                        <input class="postRequestForms marginCenter" id="distance" type="text" name="d_time" value=" "
                               style="text-align:center;" readonly>
                        <input class="postRequestForms marginCenter" id="distance" type="text" name="date" value=" "
                               style="text-align:center;" readonly>
                        <input class="postRequestForms marginCenter" id="distance" type="text" name="distance" value=" "
                               style="text-align:center;" readonly>
                        <input class="postRequestForms marginCenter" id="distance" type="text" name="rideId" value=" "
                               style="text-align:center;" readonly>
            ...
            <div class="listingRow hide">
                ...
                <div class="tabs-content" data-tabs-content="example-tabs">
                        ...
                        <ul class="listingsOfItems">
                            ...
                            while ($row = $listOfRides->fetch_assoc()) {
                                ...
                                if ($row['date'] >= date('Y-m-d')) { ?>
                                    <li class="list-item  hvr-underline-from-center"><img class="list-item-img"
                                                                                          src="./style/small_car.png"
                                                                                          href="#"
                                                                                          id='<?php echo $row['rideID']; ?>'>
                    ...
                    <div class="tabs-panel" id="panel2">
                        <p>Suspendisse dictum feugiat nisl ut dapibus. Vivamus hendrerit arcu sed erat molestie
                            vehicula. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl
                            tempor. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor.</p>
                    </div>
                </div>
            </div>
        </div>
